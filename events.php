...
<nav class="navbar navbar-expand-lg navbar-dark border border-dark bg-dark">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          <ul class="navbar-nav ms-auto me-sm-2 mt-2 mt-lg-0">
            ...
            <li class="nav-item me-3">
              <a class="nav-link bg-secondary" href="events.php">Events</a>
            </li>
            <li class="nav-item me-3">
    ...
    <h3 class="text-dark text-center">Events</h3>
    <form>  
  <div class="mb-3">
    <label for="EventDate" class="form-label">Date Recorded</label>
  ...
  <div class="mb-3">
    <label for="EventDate" class="form-label">Comments</label>
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
    <div id="emailHelp" class="form-text"></div>
  </div>
